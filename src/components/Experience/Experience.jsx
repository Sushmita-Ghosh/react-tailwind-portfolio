      ...
      <div className="flex justify-center items-center">
        <ul className=" border-gray-400 border-l-2">
          {experience.map((exp, id) => (
            <li
              key={id}
              className="m-2 md:m-10 shadow-lg dark:shadow-lg dark:shadow-purple-400 relative"
            >
                  ...
                  <ul className="mt-4">
                    {exp.experiences.map((exp, id) => (
                      <div key={id} className="flex gap-2 items-center">
                        <TbPencilStar className="min-h-2.5 min-w-2.5 md:h-4 md:w-4 text-purple-700" />
